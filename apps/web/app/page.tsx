...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-12 bg-gradient-to-br from-bg via-bg to-[#efe7db]">
      ...
      <button
        className="flex items-center gap-3 bg-bg-elevated border-[1.5px] border-line rounded-sm px-7 py-3.5 font-medium hover:border-ink-secondary hover:-translate-y-px hover:shadow-md transition-all shadow-card"
        type="button"
      >
        <svg viewBox="0 0 24 24" className="w-5 h-5">
          <path
            fill="#4285F4"
            d="M22.5 12.27c0-.83-.07-1.62-.2-2.39H12v4.51h5.91c-.26 1.37-1.04 2.53-2.21 3.31v2.74h3.57c2.09-1.93 3.23-4.77 3.23-8.17z"
          />
          <path
            fill="#34A853"
            d="M12 23c2.97 0 5.46-.98 7.27-2.66l-3.57-2.74c-.98.66-2.24 1.05-3.7 1.05-2.84 0-5.25-1.92-6.11-4.5H2.18v2.83C3.99 20.53 7.7 23 12 23z"
          />
          <path
            fill="#FBBC05"
            d="M5.89 14.15c-.22-.66-.34-1.36-.34-2.07s.13-1.41.34-2.07V7.18H2.18C1.43 8.66 1 10.28 1 12s.43 3.34 1.18 4.82l3.71-2.67z"
          />
          <path
            fill="#EA4335"
            d="M12 5.43c1.61 0 3.06.55 4.21 1.64l3.16-3.16C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.18l3.71 2.83C6.75 7.35 9.16 5.43 12 5.43z"
          />
        </svg>
        用 Google 登录
      </button>
