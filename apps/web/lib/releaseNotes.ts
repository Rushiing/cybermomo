...
export const RELEASE_NOTES: ReleaseEntry[] = [
  {
    ...
    sections: [
      ...
      },
      {
        category: "看不见但发生了什么",
        bullets: [
          "Agent 能从你过去的简报里检索相关记忆 — 你问它「上次那个人跟我合适吗」,它会从那场互聊和简报里调出来跟你聊。",
    ...
    sections: [
      {
        category: "新功能",
        bullets: [
          "「Agent 替我聊过谁」总览 — 「我」里新增了一段,所有 Agent 替你聊过的场次都能回看。对方 Agent 的私下判断不会展示。",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "你的 .md 档案你可以自己查看,也会交给你的 Agent 使用;其他用户不会看到原文,也不会因为任何匹配或推荐而暴露。",
        ],
      },
    ],
  },
