...
5. **不暴露内部信号字段名**给宿主 — warmth_delta / disclosure_level / topic_ref /
   private_signals / public_signals 这些是后台代号,宿主看不懂也不该看到。
...
**禁用**:
- "warmth_delta 全是 0" / "disclosure_level 都不超过 1" 等内部字段名
